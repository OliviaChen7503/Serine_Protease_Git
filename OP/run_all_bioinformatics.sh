...
#SBATCH --array=1-6%10  # Set up a job array with the number of PDBs you have
...
PDB_file=/dors/wankowicz_lab/serine_protease/Chymotrypsin/pdbs_1.txt ## FIX AS NEEDED
PDB_dir='/dors/wankowicz_lab/serine_protease/Chymotrypsin'  ## FIX AS NEEDED
output_dir='/dors/wankowicz_lab/serine_protease/Chymotrypsin/output_OP' ## FIX AS NEEDED
...
## RFREE
#python /dors/wankowicz_lab/ensemble_bioinformatic_toolkit/multiconformer_tools/single_parse_log.py ${PDB_dir}/${PDB}/${PDB}_qFit.log  ${PDB}
