...
# Check arguments (added chain identifier as input)
if len(sys.argv) != 5:
...
# Select alpha carbon atoms from the specified chains
...
# ======================== Key modification: Generate output file path ========================
...
# Generate output filename (without subdirectory)
