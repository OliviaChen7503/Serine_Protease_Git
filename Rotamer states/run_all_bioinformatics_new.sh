...
output_dir='/dors/wankowicz_lab/serine_protease/Chymotrypsin/output' ## FIX AS NEEDED
...
#GET RESOLUTION
#mtzmetadata=`phenix.mtz.dump "${PDB_dir}/${PDB}/${PDB}_qFit.mtz"`
...
#make_methyl_df.py ${output_dir}/${PDB}_qFit_H.pdb --pdb ${PDB}
#calc_OP.py ${output_dir}/${PDB}.dat ${output_dir}/${PDB}_qFit_H.pdb ${output_dir}/${PDB}_OP.out -r ${res} -b ${b_fac}
